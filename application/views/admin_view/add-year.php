            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="add_year" method="post">
                        <p>year</p>
                        <p><input type="number" name="q_yer" class="form-control" placeholder="2010" onkeyup="if(this.value.length > 4){this.value=this.value.substr(0, 4);} required"></p>
                        <p><input type="submit" value="ADD" name="sub_tear" class="btn btn-primary btn-block"></p>
                    </form>
                    <br>
                    <table class="table table-dark table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url(); ?>update/<?php echo $r->year_id ?>" class="btn btn-warning">Edit</a></td>
                        </tr>
                        <?php } ?>
                        </tbody>
                    </table>
