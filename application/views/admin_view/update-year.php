        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Year</h1>
                    <?php foreach ($row as $r ){?>
                    <form action="<?php echo base_url(); ?>update_year" method="post">
                        <input type="hidden" value="<?php echo $r->year_id; ?>" name="y_id">
                        <p>year</p>
                        <p><input type="number" name="q_yer" value="<?php echo $r->year; ?>" class="form-control" placeholder="2010" onkeyup="if(this.value.length > 4){this.value=this.value.substr(0, 4);} required"></p>
                        <p><input type="submit" value="UPDATE" name="sub_tear" class="btn btn-primary btn-block"></p>
                    </form>
                    <?php } ?>
