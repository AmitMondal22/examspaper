                ...
                <div class="container-fluid">
                    ...
                    <form action="submit" method="post" enctype="multipart/form-data">
                        ...
                        <p><select name="univer_id" id="" class="form-control">
                            ...
                            <option value="<?php echo $key->institute_id; ?>"><?php echo $key->institute_name; ?></option>
                            <?php } ?>
                        </select></p>
                        <p>Select stream</p>
                        ...
                        <p>Subject Name</p>
                        <p><input type="text" name="sub_name" placeholder="Enter subject name....."  class="form-control"></p>
                        <p>Upload Quastion</p>
                        <p>
                        ...
                        <p><input type="submit" value="DONE" class="btn btn-primary btn-block"></p>
                    </form>
