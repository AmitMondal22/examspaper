        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">institute-type</h1>
                    <?php foreach ($srow as $u_tin) { ?>
                    <form action="<?php echo base_url(); ?>instit-type-update" method="post">
                    <input type="hidden" name="id_typ_insti" value="<?php echo $u_tin->	institute_type_id; ?>">
                        <p>institute type</p>
                        <p><input type="text" name="typ_insti" class="form-control" value="<?php echo $u_tin->institute_type; ?>"></p>
