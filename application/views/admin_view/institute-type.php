        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="instit-type" method="post">
                        <p>institute type</p>
                        <p><input type="text" name="typ_insti" class="form-control"></p>
                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach ($t_data as $t) { ?>
                            <tr>
                                <td><?php echo $t->institute_type; ?></td>
                                <td>
                                    <a href="<?php echo base_url(); ?>edit-institute-type/<?php echo $t->institute_type_id;  ?>" class="btn btn-warning">Edit</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
