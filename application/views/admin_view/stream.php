        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Insert Stream</h1>
                    <form action="str_q" method="post">
                    <p>stream name</p>
                    <p><input type="text" name="q_stream" class="form-control"></p>
                    <p><input type="submit" value="ADD" name="sub" class="btn btn-primary btn-block"></p>
                    </form>
                    <br>
                    <table class="table table-striped">
                        ...
                        <?php foreach ($row as $r) { ?>
                            <tr>
                                <td><?php echo $r->stream_name ?></td>
                                <td><a href="<?php echo base_url(); ?>strem_edit/<?php echo $r->stream_id  ?>" class="btn btn-warning">Edit</a></td>
                                <td><a href="<?php echo base_url(); ?>delete/<?php echo $r->stream_id  ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete  <?php echo $r->stream_name ?> ?');">Remove</a></td>
