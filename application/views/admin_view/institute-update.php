        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(); ?>institute-updaet" method="post">
                        <input type="hidden" name="insti_id" value="<?php echo $e->institute_id; ?>">
                        <p>Institute name</p>
                        <p><input type="text" name="institute" class="form-control" value="<?php echo $e->institute_name; ?>"></p>
                        <p>Select Institute Type</p>
                        <p>
                            <select name="ins_typ" id="" class="form-control">
                                <option value="">Select Institute......</option>
                                <?php foreach ($ins_all as $key ) { ?>
                                <option value="<?php echo $key->institute_type_id; ?>" <?php if ($key->institute_type_id == $e->institute_type_id) {
                                    echo "selected";
                                } ?>><?php echo $key->institute_type; ?></option>
                                <?php } ?>
                            </select>
                        </p>
