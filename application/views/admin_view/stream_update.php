        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php foreach ($roj as $q) { ?>
                                        <form action="<?php echo base_url(); ?>update_stream" method="post">
                                        <input type="hidden" name="str_id" value="<?php echo $q->stream_id ?>">
                                            <p>stream name</p>
                                            <p><input type="text" name="q_stream" class="form-control" value="<?php echo $q->stream_name ?>"></p>
                                            <p><input type="submit" value="Update" name="sub-update" class="btn btn-primary btn-block"></p>
                                        </form>
                                        <?php } ?>
