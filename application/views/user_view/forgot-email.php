                            ...
                            <div class="col-lg-6 fro-cat">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b>Forgot Password</b></h1>
                                    </div>
                                    <form class="user for-pas-form" action="forgot-password" method="post">
