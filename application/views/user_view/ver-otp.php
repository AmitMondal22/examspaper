...
<?php $b=""; $a="deactivate"; foreach ($data as $key) { 
                ...
                <div class="card o-hidden border-0 shadowc my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 fro-cat">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> <b>OTP Verification</b></h1>
                                       
                                    </div>
                                    
                                    <form class="user for-pas-form" action="<?php echo base_url(); ?>otp-verification" method="post">
                                    
                                        <p class="otp-para">OTP is send to your email<?php echo $key->u_email; ?>
                                        <input type="hidden" name="u_id" value="<?php echo $key->user_id ; ?>">
                                        </p>
                                        ...
                                        <div class="form-group input-con">
                                            ...
                                            <input type="text" class=" input-field"
                                                ...
                                                placeholder="Enter OTP" pattern="\d*" inputmode="numeric" name="u_num" required>
                                        </div>
                                       
                                    
                                        <input type="submit" value="Next" class="btn d-btn btn-block">
                                        
                                        
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url(); ?>login">Sign in</a>
                                    </div>
                                    <div class="text-center">
