                                    ...
                                    <form class="user" action="<?php echo base_url(); ?>verification" method="post">
                                        <div class="form-group input-con">
                                            ...
                                            <input type="text" class=" input-field"
                                                ...
                                                placeholder="Full Name...." name="u_name" >
                                        </div>
                                        <div class="form-group input-con">
                                            <i class="fas fa-envelope"></i>
                                            <input type="email" class=" input-field"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Email Address..." name="e_email">
                                        </div>
                                        
                                        <div class="form-group input-con">
                                            <div class="fas">
                                                <label>
                                                    <input type="radio" name="u_gen" id="" class="radio-acc" name="Male" value="Male"  required> Male
                                                </label>
                                                <label>
                                                    <input type="radio" name="u_gen" id="" class="radio-acc" name="Female" value="Female" required> Female
                                                </label>
                                                <label>
                                                    <input type="radio" name="u_gen" id="" class="radio-acc" name="Others" value="Others" required> Others
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group input-con">
                                            ...
                                            <input type="password" class=" input-field"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Password" name="u_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[~,!,@,#,$,%,^,&,_,]).{8,}"  required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" id="customCheck" name="u_agree">
                                                <label class="custom-control-label" for="customCheck">I read and agree to <a href="<?php echo base_url(); ?>terms">terms & conditions</a></label>
                                            </div>
                                            
                                        </div>
                                        
                                        <input type="submit" value="create account" name="submitacc" class="btn d-btn btn-block">
