...
<?php $a='activate'; foreach ($data as $d) {
    if ($d->u_ststus = $a) {
    ?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="col-lg-6 fro-cat">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b>Generate New Password</b></h1>
                                    </div>
                                    <form class="user for-pas-form" action="<?php echo base_url(); ?>upd-password" method="post">
                                        <input type="hidden" name="u_id" value='<?php echo $d->u_email; ?>'>
                                        <input type="hidden" name="token" value="">
                                        <div class="form-group input-con">
                                            <i class="fas fa-key"></i>
                                            <input type="password" class="input-field"
                                                id="password" id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[~,!,@,#,$,%,^,&,_,]).{8,}">
                                        </div>
                                        <div class="form-group input-con">
                                            <i class="fas fa-key"></i>
                                            <input type="password" class="input-field"
                                                id="confirm_password" id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Reenter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[~,!,@,#,$,%,^,&,_,]).{8,}" name="new_password">
                                        </div>

                                        <p><span id='message'></span></p>

                                        <p class="pas-para">Password min 8 characters A-z & 0-9 special characters</p>
